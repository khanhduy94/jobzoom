//-----------------------------------------------------------------------
// <copyright file="IPrioritized.cs" company="International Monetary Fund">
...
namespace ICE.download
{
    ...
    /// <summary>
    /// This interface is ensure implementation have a priority
    /// </summary>
    public interface IPrioritized
    {
        /// <summary>
        /// Gets the priority of the current object
        /// </summary>
        ICE.download.Priority Priority
        {
            get;
        }
    }
