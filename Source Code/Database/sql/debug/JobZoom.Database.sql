/*
Deployment script for JobZoom.Demo
*/
...
GO
:setvar DatabaseName "JobZoom.Demo"
...
BEGIN
    RAISERROR(N'You cannot deploy this update script to target CONGPHUCLE-MSFT. The database for which this script was built, JobZoom.Demo, does not exist on this server.', 16, 127) WITH NOWAIT
    RETURN
END
